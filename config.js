...
//═══════[Required Variables]════════\\
global.owner = process.env.OWNER_NUMBER ? process.env.OWNER_NUMBER.replace(/[\s+]/g, '') : '2348121373516';
...
global.sudo =  process.env.SUDO ? process.env.SUDO.replace(/[\s+]/g, '') : '2348121373516'; ;
global.devs = "2348121373516"; //Dont change it From here
...
module.exports = {
  ...
  botname: process.env.BOT_NAME || 'HAKI-MD',
